...
UM.Dialog
{
    ...
    Column
    {
        ...
        TextEdit
        {
            text: "{printer_name}, {printer_name_full}, {printer_type}, {printer_type_full}, {layer_height}, {cool_fan_speed}, {machine_nozzle_size}, {infill_sparse_density}, {speed_print}, {material_print_temperature}, {material_flow}, {profile_name}, {profile_name_full}, " +
